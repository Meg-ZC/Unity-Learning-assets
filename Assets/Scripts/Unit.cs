...
public abstract class Unit : MonoBehaviour//运动单位
    //,UIMainScene.IUIInfoContent
{
    public float Speed = 3;
    protected NavMeshAgent m_Agent;
    protected Building m_Target = Base.Instance;
    ...
    private void Start()
    {
        // explosionParticle = transform.Find("FX_Explosion_Smoke").GetComponentInChildren<ParticleSystem>();
